...
//********************************
	...
	//printk("value register ICMSR = %x  ",  rcar_i2c_read(priv, ICMSR)& 0xFF);
	...
	//printk("(~MDE)& 0xFF = %x value register ICMSR = %x  ICMCR = %x ICMIER =%x ICMAR =%x\n", (~MDE)& 0xFF,  rcar_i2c_read(priv, ICMSR)& 0xFF, rcar_i2c_read(priv, ICMCR)& 0xFF, rcar_i2c_read(priv, ICMIER)& 0xFF, rcar_i2c_read(priv, ICMAR)& 0xFF);
